...
BEAT_MEDIA_COLUMNS = (
    ...
    ("video_prompt_job_id", "TEXT"),
    ("video_in_frame_url", "TEXT"),
...
class XiajiEpisodeStore:
    ...
    def _beat_from_row(self, row: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "render_status": _row_value(row, "render_status"),
            "render_error": _row_value(row, "render_error"),
            ...
            "video_status": _row_value(row, "video_status"),
            "video_error": _row_value(row, "video_error"),
            "video_prompt_zh": _row_value(row, "video_prompt_zh"),
            "video_prompt_job_id": _row_value(row, "video_prompt_job_id"),
            "video_in_frame_url": _row_value(row, "video_in_frame_url"),
